...
struct JKRAramStream : public JKRThread {
	...
	JKRAramStream::write_StreamToAram_Async(JSUFileInputStream *param_1, ulong param_2, ulong param_3, ulong param_4) {
	...
	JKRAramStream(uint p) : JKRThread(0x4000, 0x10, p) {
...
struct JKRAram : public JKRThread {
	...
	JKRAram(unsigned param_1, unsigned param_2, unsigned param_3) : JKRThread(0x4000, 0x10, param_3) {
		int aramuserbase;
		int aramsize;
		undefined4 uVar1;
		ulong uVar2;

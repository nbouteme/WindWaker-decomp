...
struct JKRDvdArchive : public JKRArchive {
	...
	ulong fetchResource_subroutine(long param_1, ulong param_2, ulong size, uchar *param_4, ulong param_5, int param_6, int isSZP);
	uint fetchResource_subroutine(long param_1, ulong param_2, ulong param_3, JKRHeap *param_4, int param_5, int param_6, uchar **param_7);

...
struct JKRExpHeap : public JKRHeap {
	...
	virtual uint getTotalFreeSize() {
	}

	virtual uint getMaxFreeBlock() {
	}
	...
	JKRExpHeap(void *param_1, ulong param_2, JKRHeap *param_3, bool param_4) : JKRHeap(param_1, param_2, param_3, param_4) {
		this->field1_0x6c = 0;
		this->gid = 0xff;

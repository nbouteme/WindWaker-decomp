...
#define GCTICKSTONANO(x) (OSTicksToNanoseconds(x) - OSTicksToSeconds(x) * 1000000000)
	...
	void OSInitContext(OSContext *param_1, void *param_2, void *param_3, u64 ss) {
		param_1->ctx.uc_stack = {param_3, 0, ss};
		makecontext(&param_1->ctx, (void (*)())param_2, 0);
	...
	bool OSCreateThread(OSThread *param_1, void *(*param_2)(void *), void *param_3, void *param_4, uint param_5,
		...
		if ((param_6 < 0) || (0x1f < param_6)) {
			...
			OSInitContext(&param_1->context, (void *)param_2, (void *)uVar1, param_5);
			u64 p = (u64)param_3;

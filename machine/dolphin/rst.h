...
namespace m_Do_Reset {
	...
	void m_Do_Reset::mDoRst_reset(undefined4 param_1, undefined4 param_2, undefined4 param_3)

	{
		...
		m_Do_Reset::destroyVideo();
		m_Do_Reset::my_OSCancelAlarmAll();
		os::LCDisable();

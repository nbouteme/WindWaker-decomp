...
int JKRAramArchive::open(long __file) {
	...
	if (__ptr == (uchar *)0x0) {
		...
		if (pJVar2 == (JKRArchive__DataHeader *)0x0) {
			...
			pJVar2 = mpDataHeader;
			mpNodes = (JKRArchive__Node *)((u64)&pJVar2->mNodeCount + pJVar2->mNodeOffs);
			pJVar2 = mpDataHeader;
			mpFileEntries =
				(SDIFileEntry *)((u64)&pJVar2->mNodeCount + pJVar2->mFileEntryOffs);
			pJVar2 = mpDataHeader;
			mpStrData = (char *)((u64)&pJVar2->mNodeCount + pJVar2->mStrTableOffs);

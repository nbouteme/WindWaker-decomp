...
void JUTDirectPrint::changeFrameBuffer(void *param_1, ushort param_2, ushort param_3) {
...
void JUTDirectPrint::erase(int param_1, int param_2, int param_3, int param_4) {
	undefined2 *puVar1;
	int iVar2;
	int iVar3;
...
void JUTDirectPrint::drawChar(int param_1, int param_2, int param_3) {
	ushort uVar1;
	undefined2 uVar3;
	int iVar2;
	undefined1 *puVar4;
...
void JUTDirectPrint::printSub(ushort param_1, ushort param_2, char *param_3, va_list param_4,
							  bool param_5) {
	int iVar1;
	uint uVar2;
	uint uVar3;
...
void JUTDirectPrint::drawString(ushort param_1, ushort param_2, char *param_3) {
	drawString_f(param_1, param_2, "%s", param_3);
}

void JUTDirectPrint::drawString_f(ushort param_1, ushort param_2, char *param_3, ...) {
	va_list ap;
	va_start(ap, param_3);
	if (oldframebuffer)
...
JUTDirectPrint *JUTDirectPrint::start(void) {
	JUTDirectPrint *self;

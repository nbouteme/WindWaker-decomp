...
uint JUTGamePad::CStick::getButton() {
	float fVar1;
	uint uVar2;
...
uint JUTGamePad::CStick::update(char param_1, char param_2, EStickMode param_3, EWhichStick param_4) {
	float fVar1;
	float fVar2;
	uint uVar3;
	double dVar4;
...
void JUTGamePad::CButton::setRepeat(ulong param_1, ulong param_2, ulong param_3) {
	this->field11_0x20 = 0;
	this->field10_0x1c = 0;
...
void JUTGamePad::CButton::update(pad::PADStatus *pPadStatus, ulong param_2) {
	uint uVar1;
	uint uVar2;
	uint uVar3;
	uint uVar4;
...
void JUTGamePad::CRumble::triggerPatternedRumble(ulong param_1) {
...
void JUTGamePad::CRumble::stopPatternedRumble(short param_1) {
	this->field1_0x4 = 0;
	stopMotorHard((int)param_1);
}

void JUTGamePad::CRumble::clear(JUTGamePad *param_1) {
	int iVar1;
...
void JUTGamePad::CRumble::startMotor(int param_1) {
...
void JUTGamePad::CRumble::stopMotor(int param_1) {
	//if ((mEnabled & JUtility::channel_mask[(int)this]) != 0) {
...
void JUTGamePad::CRumble::stopMotorHard(int index) {
...
void JUTGamePad::CRumble::startPatternedRumble(byte *param_1, ERumble param_2, ulong param_3) {
...
void JUTGamePad::CRumble::setEnabled(ulong param_1) {
	ulong extraout_r4;
	CRumble *this_00;
	int iVar1;
	byte *pbVar2;
...
void JUTGamePad::CRumble::update(short param_1) {
	uint uVar1;
...
byte JUTGamePad::mPadAssign[4];
JSUPtrList JUTGamePad::mPadList;
byte JUTGamePad::mListInitialized;
JUTGamePad *JUTGamePad::initList() {
	if (!mListInitialized) {
		mPadList.initiate();
		mListInitialized = 1;
	}
...
pad::PADStatus JUTGamePad::mPadStatus[4];
...
int JUTGamePad::sAnalogMode;
int JUTGamePad::mSuppressPadReset;

...
void GDSetVtxDescv    ( const gx::GXVtxDescList *attrPtr );

void GDSetVtxAttrFmtv ( gx::GXVtxFmt vtxfmt, const gx::GXVtxAttrFmtList *list );

void GDSetArray       ( gx::GXAttr attr, const void *base_ptr, u8 stride );

void GDSetArrayRaw    ( gx::GXAttr attr, u32 base_ptr_raw, u8 stride );

void GDPatchArrayPtr  ( const void *base_ptr );

void GDSetTexCoordGen ( gx::GXTexCoordID  dst_coord,
                        gx::GXTexGenType  func,
                        gx::GXTexGenSrc   src_param,
                        gx::GXBool        normalize,
                        u32           postmtx );

void GDSetCullMode( gx::GXCullMode cm );

void GDSetGenMode( u8 nTexGens, u8 nChans, u8 nTevs );

void GDSetGenMode2( u8 nTexGens, u8 nChans, u8 nTevs, u8 nInds, gx::GXCullMode cm );



void GDSetLPSize( u8 lineWidth, u8 pointSize,
                  gx::GXTexOffset lineOffset, gx::GXTexOffset pointOffset,
                  gx::GXBool lineHalfAspect );

void GDSetCoPlanar( gx::GXBool enable );

// for GDBegin and GDEnd we have declarations and definitions

static inline void GDBegin ( gx::GXPrimitive type, gx::GXVtxFmt vtxfmt, u16 nverts )
{

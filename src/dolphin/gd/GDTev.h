...
void GDSetTevOp(gx::GXTevStageID stage, gx::GXTevMode mode);

void GDSetTevColorCalc(
    gx::GXTevStageID    stage,
    gx::GXTevColorArg   a,
    gx::GXTevColorArg   b,
    gx::GXTevColorArg   c,
    gx::GXTevColorArg   d,
...
void GDSetTevAlphaCalcAndSwap(
    ...
    gx::GXBool          clamp,
    gx::GXTevRegID      out_reg,
    gx::GXTevSwapSel    ras_sel,
    gx::GXTevSwapSel    tex_sel );

void GDSetTevColor   ( gx::GXTevRegID reg, gx::GXColor color );
void GDSetTevColorS10( gx::GXTevRegID reg, gx::GXColorS10 color );
void GDSetTevKColor  ( gx::GXTevKColorID reg, gx::GXColor color );

// This function sets two stages at once: the one you specify
// must be an even stage number.
void GDSetTevKonstantSel( gx::GXTevStageID evenStage, 
                          gx::GXTevKColorSel kcsel0, gx::GXTevKAlphaSel kasel0,
                          gx::GXTevKColorSel kcsel1, gx::GXTevKAlphaSel kasel1 );

void GDSetTevSwapModeTable(
    gx::GXTevSwapSel    table,
    gx::GXTevColorChan  red,
    gx::GXTevColorChan  green,
    gx::GXTevColorChan  blue,
    gx::GXTevColorChan  alpha );
...
void GDSetZTexture ( gx::GXZTexOp op, gx::GXTexFmt fmt, u32 bias );

// This function sets two stages at once: the one you specify
// must be an even stage number.
void GDSetTevOrder(
    gx::GXTevStageID    evenStage, 
    gx::GXTexCoordID    coord0,
    gx::GXTexMapID      map0,
    gx::GXChannelID     color0,
    gx::GXTexCoordID    coord1,
    gx::GXTexMapID      map1,
    gx::GXChannelID     color1 );

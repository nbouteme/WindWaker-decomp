...
void GDSetTexLookupMode (
    gx::GXTexMapID      id,
    gx::GXTexWrapMode   wrap_s, 
    gx::GXTexWrapMode   wrap_t,
    gx::GXTexFilter     min_filt, 
    gx::GXTexFilter     mag_filt, 
    f32             min_lod, 
    f32             max_lod,
    f32             lod_bias,
    gx::GXBool          bias_clamp,
    gx::GXBool          do_edge_lod, 
    gx::GXAnisotropy    max_aniso );

void GDSetTexImgAttr   ( gx::GXTexMapID id, u16 width, u16 height, gx::GXTexFmt format );
void GDSetTexImgPtr    ( gx::GXTexMapID id, void *image_ptr );
void GDSetTexImgPtrRaw ( gx::GXTexMapID id, u32   image_ptr_raw );
void GDPatchTexImgPtr  ( void *image_ptr );

void GDSetTexTlut ( gx::GXTexMapID id, u32 tmem_addr, gx::GXTlutFmt format );

void GDSetTexCached ( gx::GXTexMapID id,
                      u32 tmem_even, gx::GXTexCacheSize size_even,
                      u32 tmem_odd,  gx::GXTexCacheSize size_odd );

void GDSetTexPreLoaded ( gx::GXTexMapID id, u32 tmem_even, u32 tmem_odd );

void GDSetTexCoordScale ( gx::GXTexCoordID coord, u16 s_scale, u16 t_scale );

void GDSetTexCoordScale2 ( gx::GXTexCoordID coord,
                           u16 s_scale, gx::GXBool s_bias, gx::GXBool s_wrap,
                           u16 t_scale, gx::GXBool t_bias, gx::GXBool t_wrap);

void GDSetTexCoordScaleAndTOEs ( gx::GXTexCoordID coord,
                                 u16 s_scale, gx::GXBool s_bias, gx::GXBool s_wrap,
                                 u16 t_scale, gx::GXBool t_bias, gx::GXBool t_wrap,
                                 gx::GXBool line_offset, gx::GXBool point_offset);

void GDLoadTlut     ( void *tlut_ptr,     u32 tmem_addr, gx::GXTlutSize size );
void GDLoadTlutRaw  ( u32   tlut_ptr_raw, u32 tmem_addr, gx::GXTlutSize size );
